        ...
        for ($counteri = 1; $counteri <= 12; $counteri++)
        {
            ...
            if ($result_invoice != null)
            {
                ...
                if($collection != NULL)
                {
                    ...
                    {
                        foreach($single_collection as $single_collection_itm)
                        {
                            $total = 0;
                            $subtotal = 0;
                            $subtotal = $single_collection_itm->price * $single_collection_itm->qty;
                            $totalexpense = $totalexpense + ($single_collection_itm->purchase * $single_collection_itm->qty);
                ...
                $revenue_arr[$arr_ctr] = number_format($totalrevenue,2,'.','');
                $Totalexpense[$arr_ctr] = number_format($totalexpense,2,'.','');
                $profit_arr[$arr_ctr] = number_format($totalprofit,2,'.','');
            }
            else
            {
