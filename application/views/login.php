...
<body class="hold-transition login-page " style="background-image:url('<?php echo base_url(); ?>uploads/systemimgs/<?php echo $bg_link;?>'); background-size:cover; position: relative;">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url('login'); ?>"> <b>MEDIX | V3.0 </b></a>
				...
				<div class="row"><hr />
                    <div class="col-xs-12">
                       <table class="table table-bordered">
								<tr>
									<td>Email</td><td>medix@spantiklab.com</td>	
								</tr>
								<tr>
