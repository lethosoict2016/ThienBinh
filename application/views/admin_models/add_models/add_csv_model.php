...
<h4 class="modal-title"><i class="fa fa-upload" aria-hidden="true"></i> 
	Upload CSV file <br />
	<small style="color:#c00;">Please Make sure to remove titles (1st row) before importing the csv file.</small>
</h4>
</div>
