                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php           
                                $data = array('class'=>'form-control input-lg','type'=>'text','name'=>'product_name','placeholder'=>'e.g Panadol','reqiured'=>'');
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php           
                                $data = array('class'=>'form-control input-lg','type'=>'text','name'=>'generic_name','placeholder'=>'e.g Paracetamol','reqiured'=>'');
                                echo form_input($data);         
                                ?> 
                            </div>
